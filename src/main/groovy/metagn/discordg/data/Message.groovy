...
class Message extends DiscordObject {
	...
	Snowflake getGuildId() { guildIdField ?: client.channelGuildIdMap[channelId] }
...
class Embed extends DiscordObject {
	...
	static class Footer extends EmbedObject {
		...
		String getName() { text }
		InputStream newIconInputStream() { super.inputStreamFromDiscord(iconUrl) }
		File downloadIcon(file) { super.downloadFileFromDiscord(iconUrl, file) }
	}
